...
impl Block {
    ...
    fn as_vec(&self, id: Id) -> Vec<f64> {
        vec![
            id as f64,
            self.instated as f64,
            self.last_used[0] as f64,
            self.last_used[1] as f64,
...
impl Cache {
    ...
    pub fn new() -> Cache {
        Cache {
            blocks: HashMap::new(),
            nn: NN::new(&[5, 6, 1], Activation::PELU, Activation::Sigmoid),
            clock: 0,
        }
    }
    ...
    pub fn cold(&mut self) -> ColdIter {
        ...
        for (&id, block) in self.blocks.iter() {
            ...
            heap.push(Prediction { id, prediction });
        }
